    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Choose fresh ingredients.</li>
          <li>Prepare all vegetables by washing and chopping.</li>
          <li>Cook spices in oil, then add vegetables and protein.</li>
          <li>Simmer until flavours blend, then garnish and serve hot.</li>
        </ol>
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-teslabot" src="/images/cat.jpeg" height="200px" /></div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
        <form id="wd-text-fields">
          ...
          <select multiple id="wd-select-many-genre" defaultValue={["SCIFI", "COMEDY"]}>
            <option value="COMEDY"> Comedy </option>
            <option value="DRAMA"> Drama </option>
            <option value="SCIFI"> Science Fiction </option>
            <option value="FANTASY"> Fantasy </option>
